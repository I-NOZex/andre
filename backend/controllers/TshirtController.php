...
class TshirtController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			...
			array('allow', // allow authenticated user to perform 'new' and 'update' actions
	...
	{
		$model=new Tshirt('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Tshirt']))
			$model->attributes=$_GET['Tshirt'];
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='tshirt-form')
		{
