...
--
-- Host: 127.0.0.1
-- Generation Time: 13-Fev-2014 às 00:58
...
-- Database: `funnyshirt`
--
CREATE DATABASE IF NOT EXISTS `funnyshirt` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `funnyshirt`;
...
(5, 'message', NULL, NULL),
(6, 'user', NULL, NULL),
(7, 'backendLogin', NULL, 'Login na area de administraçao');
...
CREATE TABLE IF NOT EXISTS `encomenda` (
  `IDEncomenda` int(10) NOT NULL AUTO_INCREMENT,
  `IDCliente` int(10) unsigned NOT NULL,
  `Data` date NOT NULL,
  `Total` decimal(19,4) NOT NULL,
  `NumVisa` decimal(16,0) NOT NULL,
  `Endereco` varchar(256) NOT NULL,
  `Entregue` bit(1) NOT NULL DEFAULT b'0',
  PRIMARY KEY (`IDEncomenda`),
  KEY `fk_encomenda_profile1_idx` (`IDCliente`)
...
(14, 1, '2014-02-12', '4060.0000', '4222222222222222', 'Pila linda', b'0'),
(15, 1, '2014-02-12', '215.0000', '4222222222222222', 'Pila linda', b'0');
...
DROP TABLE IF EXISTS `imagemtshirt`;
CREATE TABLE IF NOT EXISTS `imagemtshirt` (
  `ID` int(10) NOT NULL AUTO_INCREMENT,
  `IDTShirt` int(10) NOT NULL,
  `TipoImagem` tinyint(1) NOT NULL DEFAULT '0',
  `Path` varchar(256) NOT NULL,
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=97 ;

--
-- Extraindo dados da tabela `imagemtshirt`
--

INSERT INTO `imagemtshirt` (`ID`, `IDTShirt`, `TipoImagem`, `Path`) VALUES
(87, 28, 2, 't_shirt_v2_casamento.jpg'),
(95, 27, 2, 't_shirt_v2_happy_pills.jpg'),
(96, 27, 3, 't_shirt_v2_push_play.jpg');
...
CREATE TABLE IF NOT EXISTS `linhaencomenda` (
  `IDLinhaEncomenda` int(10) NOT NULL AUTO_INCREMENT,
  `IDEncomenda` int(10) NOT NULL,
  `IDTShirt` int(10) NOT NULL,
...
(1, 14, 27, 145, 'XS', '15.0000'),
(2, 14, 28, 145, 'S', '13.0000'),
(3, 15, 27, 10, 'XS', '15.0000'),
(4, 15, 28, 5, 'M', '13.0000');
...
(1, 0, 'user', 5, 0, 0, ''),
(5, 0, 'role', 5, 1, 0, 'Demo role can write messages'),
(5, 0, 'role', 6, 2, 0, 'User Manager can read other users'),
(5, 0, 'role', 7, 0, 0, '');

-- --------------------------------------------------------

--
-- Estrutura da tabela `privacysetting`
--
...
--
-- Extraindo dados da tabela `privacysetting`
--
...
CREATE TABLE IF NOT EXISTS `profile` (
  ...
  `about` text,
  PRIMARY KEY (`id`),
  KEY `fk_encomenda_profile` (`user_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=5 ;
...
INSERT INTO `profile` (`id`, `user_id`, `firstname`, `lastname`, `email`, `street`, `city`, `about`) VALUES
(1, 1, 'admin', 'admin', 'webmaster@example.com', NULL, NULL, NULL),
(2, 2, 'demo', 'demo', 'demo@example.com', NULL, NULL, NULL),
(3, 4, 'lalala', 'admin', 'simplesmente_moi@hotmail.com', NULL, NULL, NULL),
(4, 5, 'ze', 'botins', '', '', '', '');

-- --------------------------------------------------------

--
-- Estrutura da tabela `profile_comment`
--
...
--
-- Estrutura da tabela `profile_visit`
--
...
(5, 'funcionario', '', NULL, NULL, NULL),
(6, 'cliente', '', NULL, NULL, NULL);
...
--
-- Extraindo dados da tabela `translation`
--
...
('Access control', 'Controlo de Acesso', 'pt', 'yum'),
...
('Active users', 'Utilizadores activos', 'pt', 'yum'),
...
('Admin inbox', 'Caixa de entrada', 'pt', 'yum'),
...
('Admin users', 'Gerir utilizadores', 'pt', 'yum'),
...
('All', 'Todos', 'pt', 'yum'),
('All', '所有', 'zh_cn', 'yum'),
('All Profile visits in the system', 'Todas as Visitas de perfil no Sistema', 'pt', 'yum'),
...
('Allow profile comments', 'Permitir comentários ao perfil', 'pt', 'yum'),
...
('Allowed roles', 'Funções permitidas', 'pt', 'yum'),
...
('Browse usergroups', 'Procurar grupos de utilizadores', 'pt', 'yum'),
...
('Cancel deletion', 'Cancelar eliminação', 'pt', 'yum'),
...
('Cancel request', 'Cancelar pedido', 'pt', 'yum'),
('Cancel request', '取消访问', 'zh_cn', 'yum'),
('Cancel subscription', 'Mitgliedschaft beenden', 'de', 'yum'),
('Cancel subscription', 'Cancelar subscrição', 'pt', 'yum'),
...
('Category', 'Categoria', 'pt', 'yum'),
('Category', '类别', 'zh_cn', 'yum'),
('Change Password', 'Alterar Palavra-Passe', 'pt', 'yum'),
...
('Change admin Password', 'Alterar password de admin', 'pt', 'yum'),
...
('Changes are saved', 'As alterações foram guardadas', 'pt', 'yum'),
...
('Changes is saved.', 'Alteração guardada.', 'pt', 'yum'),
...
('Column field type in the database', 'Tipo de coluna do campo na base de dados', 'pt', ''),
...
('Create Action', 'Criar ação', 'pt', 'yum'),
...
('Create new Translation', 'Criar nova tradução', 'pt', 'yum'),
...
('Create new User', 'Criar novo Utilizador', 'pt', 'yum'),
...
('Create new action', 'Criar nova acção', 'pt', 'yum'),
...
('Create new payment type', 'Nova forma de pagamento', 'pt', 'yum'),
...
('Create new role', 'Criar novo cargo', 'pt', 'yum'),
...
('Create new usergroup', 'Criar novo grupo de utilizadores', 'pt', 'yum'),
...
('Delete account', 'Cancelar conta', 'pt', 'yum'),
('Delete account', '删除账户', 'zh_cn', 'yum'),
...
('Edit personal data', 'Editar dados pessoais', 'pt', 'yum'),
...
('Edit profile', 'Editar perfil', 'pt', 'yum'),
...
('Error message when validation fails.', 'Mensagem de erro quando a validação falha', 'pt', 'yum'),
...
('Fields with * are required.', 'Campos com * são obrigatórios.', 'pt', 'yum'),
...
('Fields with <span class="required">*</span> are required.', 'Campos com <span class="required">*</span> são obrigatórios.', 'pt', 'yum'),
...
('Grant permission', 'Atribuir permições', 'pt', 'yum'),
('Grant permission', '提升权限', 'zh_cn', 'yum'),
('Grant permission to new users', 'Atribuir permição a novos utilizadores', 'pt', 'yum'),
...
('Hidden', 'Скрыт', 'ru', 'yum'),
('Hidden', '隐藏', 'zh_cn', 'yum'),
('Higher is usually more worthy. This is used to determine downgrade possibilities.', 'Maior é geralmente mais superior. Isto é usado para determinar as possibilidades de downgrade.', 'pt', 'yum'),
('Hint displayed to user e.g "You can enter more values and separate them using comma".', 'Sugestão exibida ao utilizador, exemplo: "Pode inserir mais valores e separá-los usando vírgula".', 'pt', 'yum'),
...
('How expensive is a membership? Set to 0 to disable membership for this role', 'Quanto custa a subscrição? Defina como 0 para desactivar a subscrição neste cargo', 'pt', 'yum'),
...
('Leave empty or set to 0 to disable membership for this role.', 'Deixem em branco ou meta zero  para desactivar a subscrição para este cargo.', 'pt', 'yum'),
('Leave group', 'Gruppe verlassen', 'de', 'yum'),
('Leave group', '离开群组', 'zh_cn', 'yum'),
('Leave password  empty  to generate a random Password', 'Deixa em branco para gerar uma password aleatória ', 'pt', 'yum'),
('Leave password  empty  to keep it  unchanged ', 'Deixa em branco para manter a password', 'pt', 'yum'),
...
('Logged in as', 'Sessão iniciada como', 'pt', 'yum'),
...
('Login Type', 'Tipo de inicio de sessão', 'pt', 'yum'),
...
('Login allowed by Email and Username', 'Inicio de sessão por Email ou Nome de Utilizador', 'pt', 'yum'),
...
('Login allowed only by Email', 'Inicio de sessão apenas por Email', 'pt', 'yum'),
...
('Login allowed only by Username', 'Inicio de sessão apenas por Nome de Utilizador', 'pt', 'yum'),
...
('Login is not possible with the given credentials', 'O inicio de sessão não é possível com os dados introduzidos', 'pt', 'yum'),
...
('Lost password?', 'Esqueces-te palavra-passe?', 'pt', 'yum'),
('Lost password?', 'Забыли пароль?', 'ru', 'yum'),
('Lost password?', '忘记密码了？', 'zh_cn', 'yum'),
...
('Manage Actions', 'Gerir ações', 'pt', 'yum'),
...
('Manage Translations', 'Gerir Traduções', 'pt', 'yum'),
...
('Manage profiles', 'Gerir perfis', 'pt', 'yum'),
('Manage profiles', '管理简介', 'zh_cn', 'yum'),
...
('Membership', 'Membros', 'pt', 'yum'),
('Membership', '会员关系', 'zh_cn', 'yum'),
('Membership Priority', 'Prioridade da subscrição', 'pt', 'yum'),
...
('New password is saved.', 'Nova palavra-passe guardada.', 'pt', 'yum'),
...
('New users registered today', 'Novos registos hoje', 'pt', 'yum'),
...
('Ordered memberships', 'Pedidos de adesão', 'pt', 'yum'),
...
('Password is incorrect.', 'Palavra-Passe incorrecta.', 'pt', 'yum'),
...
('Password recovery', 'Recuperação da palavra-passe', 'pt', 'yum'),
...
('Passwords do not match', 'As palavras-passes não coincidem', 'pt', 'yum'),
...
('Payment types', 'Formas de pagamento', 'pt', 'yum'),
...
('Please fill out the following form with your login credentials:', 'Por favor preenche o seguinte formulário com as tuas credenciais de início de sessão:', 'pt', 'yum'),
...
('Privacy settings', 'Opções de privacidade', 'pt', 'yum'),
...
('Privacy settings for {username}', 'Opções de privacidade para {username}', 'pt', 'yum'),
...
('Regular expression (example:''/^[A-Za-z0-9s,] $/u'').', 'Expressão regular (exemplo: ''/^[A-Za-z0-9s,]+$/u'' ).', 'pt', 'yum'),
...
('Remove Avatar', 'Remover Avatar', 'pt', 'yum'),
...
('Retype Password', 'Rescreva a palavra-passe', 'pt', 'yum'),
...
('Save payment type', 'Guardar tipo de pagamento', 'pt', 'yum'),
...
('Save profile changes', 'Guardar as alterações efectuadas ao perfil', 'pt', 'yum'),
...
('Save role', 'Guardar cargo', 'pt', 'yum'),
...
('Sent messages', 'Mensagens enviadas', 'pt', 'yum'),
...
('Set to >0 to enable membership for this role and set a priority.', 'Defina >0 para activar a subscrição para este cargo e definir a prioridade.', 'pt', 'yum'),
...
('Show profile visits', 'Ver visitas ao perfil', 'pt', 'yum'),
...
('Statistics', 'Estatísticas', 'pt', 'yum'),
...
('Text Login Footer', 'Texto de Inicio de Sessão no Rodapé', 'pt', 'yum'),
...
('Text Login Header', 'Texto de Inicio de Sessão no Cabeçalho', 'pt', 'yum'),
...
('Text translations', 'Traduções', 'pt', 'yum'),
...
('The comment has been saved', 'O comentário foi guardado', 'pt', 'yum'),
...
('The new password has been saved', 'A nova palavra-passe foi guardada', 'pt', 'yum'),
...
('These users have been assigned to this role', 'Uzytkownik zostal przypisany do rol', 'pl', 'yum'),
('These users have been assigned to this role', 'Estes utilizadores foram atribuidos a este cargo', 'pt', 'yum'),
('These users have been assigned to this role', '这些用户已经被授权给这个角色', 'zh_cn', 'yum'),
...
('Time of first visit', 'Data da primeira visita', 'pt', 'yum'),
('Time of last visit', 'Data da ultima visita', 'pt', 'yum'),
...
('To', 'A', 'it', 'yum'),
('To', '至', 'zh_cn', 'yum'),
('Total Num of Visits', 'Nº total de visitas', 'pt', 'yum'),
('Total users', 'Total de utilizadores', 'pt', 'yum'),
('Translation', 'Übersetzung', 'de', 'yum'),
('Translation', 'Traducción', 'es', 'yum'),
('Translation', 'Tradução', 'pt', 'yum'),
...
('Translations have been saved', 'As traduções foram guardadas', 'pt', 'yum'),
...
('Upload Avatar', 'Carregar Avatar', 'pt', 'yum'),
...
('Upload avatar for admin', 'Carregar avatar para o administrador', 'pt', 'yum'),
...
('Upload avatar image', 'Carregar imagem de avatar', 'pt', 'yum'),
('Upload avatar image', '上传我的头像', 'zh_cn', 'yum'),
...
('User Administration', 'Gestão de Utilizadores', 'pt', 'yum'),
...
('User administration', 'Administração de utilizadores', 'pt', 'yum'),
...
('Username', 'Nome de Utilizador', 'pt', 'yum'),
...
('Visited', 'Visitou', 'pt', 'yum'),
('Visitor', 'Visitante', 'pt', 'yum'),
...
('Write a message', 'Escrever mensagem', 'pt', 'yum'),
...
('Written from', 'Escrito por', 'pt', 'yum'),
...
('Your Avatar image', 'A tua imagem de Avatar', 'pt', 'yum'),
...
('Your changes have been saved', 'As tuas alterações foram guardadas', 'pt', 'yum'),
...
('Your new password has been saved.', 'A tua nova palavra-passe foi guardada.', 'pt', 'yum'),
...
('Your privacy settings have been saved', 'As opções de privacidade foram guardadas', 'pt', 'yum'),
...
('Your subscription setting has been saved', 'As tuas definições de subscrição foram guardadas', 'pt', 'yum'),
...
('{attribute} is too long (max. {num} characters).', '{attribute} é demasiado longo (max. {num} caracteres).', 'pt', 'yum'),
...
('{attribute} is too short (min. {num} characters).', '{attribute} é demasiado curto (min. {num} caracteres).', 'pt', 'yum'),
...
('{attribute} must include at least {num} digits.', '{attribute} deve de ter pelo menos {num} dígitos.', 'pt', 'yum'),
...
('{attribute} must include at least {num} lower case letters.', '{attribute} deve de ter pelo menos {num} caracteres em minúscula.', 'pt', 'yum'),
...
('{attribute} must include at least {num} symbols.', '{attribute} deve de ter pelo menos {num} símbolos.', 'pt', 'yum'),
...
('{attribute} must include at least {num} upper case letters.', '{attribute} deve de ter pelo menos {num} caracteres en maiúscula.', 'pt', 'yum'),
...
('{attribute} must not contain more than {num} sequentially repeated characters.', '{attribute} não deve ter mais de {num} caracteres repetidos sequencialmente.', 'pt', 'yum'),
...
('{attribute} must not contain whitespace.', '{attribute} não deve de contar espaços.', 'pt', 'yum'),
('{attribute} must not contain whitespace.', '{attribute}不能包含空格', 'zh_cn', 'yum'),
('{username} has no friends yet', '{username} ainda não tem amigos', 'pt', 'yum');
...
(27, 'Happy Pills', '15.00', '2014-01-06 00:00:00'),
(28, 'Casamento', '13.00', '2014-01-05 00:00:00');
...
(1, 'admin', '$2a$13$cOSIDBhuG9Ngd8Zg6QmmWuEAKoTliZMIoDmKRxYp389ScCMirvIuq', '', 1389393321, 1392249121, 0, 0, 0, 1, 1, 'images/1_i_frgt.jpg', 'Instant'),
(2, 'demo', '$2a$13$4y/fbBFwKQebZvYvmjPE5eKxSs4LxBfxK7KpUTZHi6nm71ACRrSLS', '', 1389393323, 0, 0, 0, 1, 0, -1, NULL, 'Instant'),
(3, 'test', '$2a$13$uJjS96vJnyZYmpEBw2HfT.9kyINJ6CPp1DDpfZsfs3gDb0gJ5tAWC', '$2a$13$uslHpQzP.Rv2Dq6LMeAbYeHy1unfrzS3eSA51nVfLnRwIgpPSrmma', 1390842288, 0, 0, 1391966454, 0, 0, 1, NULL, 'Instant'),
(4, 'i-nozex', '$2a$13$ucxMk4Eez5jQJAAXl9aV0exOehCS45aqwpu.0KJlkNcsUR2bZoSJ6', '$2a$13$2HJlFICWzKzUhkQkptpPbeIjcmam0UGTJ3bMnPaRAVsoLC2bdSfqa', 1392046033, 0, 0, 1392046031, 0, 0, 0, 'gravatar', 'Instant'),
(5, 'zex', '$2a$13$k1AqsNhy4S2C6dPzUyUIsusFIY8yFEIXtHMW7dSrjtXmFPWqq2.1K', '$2a$13$uVlEdmPzGdf9JvBkeJWxseJ/OjkFrHtVmlOU/ZjbW5kHN4R5zNl.y', 1392219267, 1392219311, 0, 1392219263, 0, 0, 1, NULL, 'Instant');
...
ALTER TABLE `encomenda`
  ADD CONSTRAINT `fk_encomenda_profile` FOREIGN KEY (`IDCliente`) REFERENCES `profile` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Limitadores para a tabela `linhaencomenda`
--
ALTER TABLE `linhaencomenda`
  ADD CONSTRAINT `fk_linhaencomenda_encomenda1` FOREIGN KEY (`IDEncomenda`) REFERENCES `encomenda` (`IDEncomenda`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_linhaencomenda_tshirt1` FOREIGN KEY (`IDTShirt`) REFERENCES `tshirt` (`ID`) ON DELETE NO ACTION ON UPDATE NO ACTION;
